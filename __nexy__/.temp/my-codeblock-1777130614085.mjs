...
function MyCodeBlock({ code, className }) {
  return /* @__PURE__ */ jsx(CodeBlock, { code, language: "js", children: /* @__PURE__ */ jsx(CodeBlock.Code, { className: "bg-gray-900 p-6 rounded-xl shadow-lg", children: /* @__PURE__ */ jsx(CodeBlock.LineContent, { children: /* @__PURE__ */ jsx(CodeBlock.Token, {}) }) }) });
}
