...
var require_dist = __commonJS({
  "node_modules/prism-react-renderer/dist/index.js"(exports, module) {
    "use strict";
    ...
    var require_prism = __commonJS2({
      "../../node_modules/.pnpm/prismjs@1.29.0_patch_hash=vrxx3pzkik6jpmgpayxfjunetu/node_modules/prismjs/prism.js"(exports2, module2) {
        var Prism2 = (function() {
    ...
    var useGetLineProps = (themeDictionary) => (0, import_react5.useCallback)(
      (_a) => {
    ...
    var import_clsx2 = __toESM2(require_clsx());
    var useGetTokenProps = (themeDictionary) => {
      const styleForToken = (0, import_react22.useCallback)(
        ({ types, empty }) => {
    ...
    var Highlight22 = (props) => (0, import_react4.createElement)(Highlight2, __spreadProps(__spreadValues({}, props), {
...
var import_prism_react_renderer = __toESM(require_dist(), 1);
...
// node_modules/react-code-block/dist/contexts.js
var RootContext = createContext(void 0);
var LineContext = createContext(void 0);
...
var CodeBlock = ({ code, words = [], lines = [], children, ...props }) => {
  ...
  return _jsx(RootContext.Provider, { value: { code: code.trim(), words: parsedWords, lines, ...props }, children });
};
var Code = ({ as, children, ...props }, ref) => {
  const { lines, words, ...highlightProps } = useRootContext();
  const Tag = as ?? "pre";
  return _jsx(import_prism_react_renderer.Highlight, { ...highlightProps, children: (highlight) => _jsx(Tag, { ...props, ref, children: highlight.tokens.map((line, i) => {
    const lineNumber = i + 1;
    const isLineHighlighted = shouldHighlightLine(lineNumber, lines);
    return _jsx(LineContext.Provider, { value: { highlight, line, lineNumber }, children: typeof children === "function" ? children({ isLineHighlighted, lineNumber }, i) : children }, i);
  }) }) });
};
var LineContent = ({ as, children, className, ...rest }, ref) => {
  ...
  const Tag = as ?? "div";
  return _jsx(Tag, { ...getLineProps({ line, className }), ...rest, ref, children });
};
var Token = ({ as, children = ({ children: children2 }) => _jsx("span", { children: children2 }), className, ...rest }, ref) => {
  ...
  return _jsx(React.Fragment, { children: line.map((token, key) => {
    ...
    return _jsx(React.Fragment, { children: content.map((content2, i) => _jsx(Tag, { ...props, ...rest, ref, children: children({
      children: content2,
...
var LineNumber = ({ as, ...props }, ref) => {
  ...
  const Tag = as ?? "span";
  return _jsx(Tag, { ...props, ref, children: lineNumber });
};
...
// src/components/my-codeblock.tsx
import { jsx } from "react/jsx-runtime";
function MyCodeBlock({ children, className, code, caller }) {
  return /* @__PURE__ */ jsx(CodeBlock, { code: children, language: "js", children: /* @__PURE__ */ jsx(CodeBlock.Code, { className: "bg-gray-900 p-6 rounded-xl shadow-lg", children: /* @__PURE__ */ jsx(CodeBlock.LineContent, { children: /* @__PURE__ */ jsx(CodeBlock.Token, {}) }) }) });
}
var my_codeblock_default = MyCodeBlock;
export {
  my_codeblock_default as default
};
/*! Bundled license information:

prism-react-renderer/dist/index.js:
  (*! Bundled license information:
