...
function Search() {
  return /* @__PURE__ */ jsxs("button", { className: " flex items-center gap-2 text-sm text-muted-foreground border border-border rounded-full px-3 py-1.5 bg-gray-100/20 hover:bg-muted transition-colors duration-300", children: [
