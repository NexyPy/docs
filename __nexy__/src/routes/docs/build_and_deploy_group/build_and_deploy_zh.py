...
def Build_and_deploy_zh(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/build_and_deploy_group/build_and_deploy_zh.md", context))
