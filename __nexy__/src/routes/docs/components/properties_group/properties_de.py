...
def Properties_de(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/components/properties_group/properties_de.md", context))
