...
def Properties_ko(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/components/properties_group/properties_ko.md", context))
