...
def Create_a_projet_ru(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/create_a_projet_group/create_a_projet_ru.md", context))
