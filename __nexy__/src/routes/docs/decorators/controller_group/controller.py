...
def Controller(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/decorators/controller_group/controller.md", context))
