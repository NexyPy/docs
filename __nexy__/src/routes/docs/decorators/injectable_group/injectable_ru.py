...
def Injectable_ru(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/decorators/injectable_group/injectable_ru.md", context))
