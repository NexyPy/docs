...
def Middleware_ru(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/decorators/middleware_group/middleware_ru.md", context))
