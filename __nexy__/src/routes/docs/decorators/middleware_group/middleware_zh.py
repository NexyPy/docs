...
def Middleware_zh(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/decorators/middleware_group/middleware_zh.md", context))
