...
def Useguard_ja(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/decorators/useguard_group/useguard_ja.md", context))
