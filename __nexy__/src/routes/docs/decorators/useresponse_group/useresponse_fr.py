...
def Useresponse_fr(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/decorators/useresponse_group/useresponse_fr.md", context))
