...
def Useroute_ja(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/decorators/useroute_group/useroute_ja.md", context))
