...
def Custom_docs_pt(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fastapi/custom-docs_group/custom_docs_pt.md", context))
