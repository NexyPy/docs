...
def Debugging_fr(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fastapi/debugging_group/debugging_fr.md", context))
