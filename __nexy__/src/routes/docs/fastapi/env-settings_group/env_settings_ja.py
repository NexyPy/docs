...
def Env_settings_ja(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fastapi/env-settings_group/env_settings_ja.md", context))
