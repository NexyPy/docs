...
def Generate_clients_de(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fastapi/generate-clients_group/generate_clients_de.md", context))
