...
def Lifespan_events_es(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fastapi/lifespan-events_group/lifespan_events_es.md", context))
