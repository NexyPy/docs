...
def Openapi_webhooks_fr(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fastapi/openapi-webhooks_group/openapi_webhooks_fr.md", context))
