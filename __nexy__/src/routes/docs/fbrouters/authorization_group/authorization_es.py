...
def Authorization_es(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/authorization_group/authorization_es.md", context))
