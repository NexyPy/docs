...
def Background_tasks_ru(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/background-tasks_group/background_tasks_ru.md", context))
