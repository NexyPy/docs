...
def Cookie_header(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/cookie-header_group/cookie_header.md", context))
