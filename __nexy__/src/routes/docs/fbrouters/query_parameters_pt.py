...
def Query_parameters_pt(caller: Any = None, children: str = '') -> str:
    ...
    context = {"pathname": pathname, "useSearchParams": useSearchParams, "params": params, "Link": Link, "usePathname": usePathname, 'Slot': Slot, 'trans': __trans, '__locale': __current_locale.get()}
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/query_parameters_pt.md", context))
