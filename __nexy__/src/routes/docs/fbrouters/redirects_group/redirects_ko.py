...
def Redirects_ko(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/redirects_group/redirects_ko.md", context))
