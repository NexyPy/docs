...
def Request_body_fr(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/request-body_group/request_body_fr.md", context))
