...
def Request_body_pt(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/request-body_group/request_body_pt.md", context))
