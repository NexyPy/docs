...
def Response_model_pt(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/response-model_group/response_model_pt.md", context))
