...
def Websocket_ko(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/fbrouters/websocket_group/websocket_ko.md", context))
