...
def Data_loading_hi(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/guides/data-loading_group/data_loading_hi.md", context))
