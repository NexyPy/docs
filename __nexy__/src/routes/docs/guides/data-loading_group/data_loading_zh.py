...
def Data_loading_zh(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/guides/data-loading_group/data_loading_zh.md", context))
