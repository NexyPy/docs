...
def Error_handling_fr(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/guides/error-handling_group/error_handling_fr.md", context))
