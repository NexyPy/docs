...
def Error_handling_hi(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/guides/error-handling_group/error_handling_hi.md", context))
