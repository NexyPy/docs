...
def Static_files_fr(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/guides/static-files_group/static_files_fr.md", context))
