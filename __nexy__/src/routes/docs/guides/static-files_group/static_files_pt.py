...
def Static_files_pt(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/guides/static-files_group/static_files_pt.md", context))
