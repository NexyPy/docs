...
def UseCookies_pt(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/hooks/useCookies_group/useCookies_pt.md", context))
