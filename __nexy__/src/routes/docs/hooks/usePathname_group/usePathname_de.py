...
def UsePathname_de(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/hooks/usePathname_group/usePathname_de.md", context))
