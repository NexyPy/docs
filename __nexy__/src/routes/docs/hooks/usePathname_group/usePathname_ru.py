...
def UsePathname_ru(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/hooks/usePathname_group/usePathname_ru.md", context))
