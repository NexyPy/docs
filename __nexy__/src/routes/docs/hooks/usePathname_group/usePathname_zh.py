...
def UsePathname_zh(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/hooks/usePathname_group/usePathname_zh.md", context))
