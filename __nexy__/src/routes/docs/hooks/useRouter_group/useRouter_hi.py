...
def UseRouter_hi(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/hooks/useRouter_group/useRouter_hi.md", context))
