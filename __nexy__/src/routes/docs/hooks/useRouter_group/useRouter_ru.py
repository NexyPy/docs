...
def UseRouter_ru(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/hooks/useRouter_group/useRouter_ru.md", context))
