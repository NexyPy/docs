...
def UseSearchParams_ru(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/hooks/useSearchParams_group/useSearchParams_ru.md", context))
