...
def UseSession_fr(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/hooks/useSession_group/useSession_fr.md", context))
