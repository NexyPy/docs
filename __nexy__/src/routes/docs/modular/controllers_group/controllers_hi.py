...
def Controllers_hi(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/modular/controllers_group/controllers_hi.md", context))
