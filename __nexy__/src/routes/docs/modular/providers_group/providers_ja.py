...
def Providers_ja(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/modular/providers_group/providers_ja.md", context))
