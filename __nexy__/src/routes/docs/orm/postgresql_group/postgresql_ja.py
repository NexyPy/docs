...
def Postgresql_ja(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/orm/postgresql_group/postgresql_ja.md", context))
