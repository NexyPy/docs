...
def Sqlalchemy_es(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/orm/sqlalchemy_group/sqlalchemy_es.md", context))
