...
def Sqlalchemy_ko(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/orm/sqlalchemy_group/sqlalchemy_ko.md", context))
