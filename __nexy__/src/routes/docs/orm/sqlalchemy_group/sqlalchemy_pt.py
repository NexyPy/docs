...
def Sqlalchemy_pt(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/orm/sqlalchemy_group/sqlalchemy_pt.md", context))
