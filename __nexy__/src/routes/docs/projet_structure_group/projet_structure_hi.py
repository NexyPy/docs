...
def Projet_structure_hi(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/projet_structure_group/projet_structure_hi.md", context))
