...
def Router_choice_de(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/router-choice_group/router_choice_de.md", context))
