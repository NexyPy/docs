...
def Authentication_ko(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/security/authentication_group/authentication_ko.md", context))
