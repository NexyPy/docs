...
def Encryption_hashing(caller: Any = None, children: str = '') -> str:
    ...
    rendered = str(__Template().render("__nexy__/src/routes/docs/security/encryption-hashing_group/encryption_hashing.md", context))
